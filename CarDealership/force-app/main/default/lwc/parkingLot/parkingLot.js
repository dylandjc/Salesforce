...
import initializeLotData from "@salesforce/apex/ParkingLotController.initializeLotData";
import { encodeDefaultFieldValues } from 'lightning/pageReferenceUtils';
import parkingLotLandingPage from "@salesforce/apex/ParkingLotController.parkingLotLandingPage";
import lotSectionsPage from "@salesforce/apex/ParkingLotController.lotSectionsPage";
// Convert our literal Vehicle__c.Color__c color strings into modern-looking colors
// TODO - Need a few others, I think


export default class ParkingLot extends NavigationMixin(LightningElement) {
    rowsSelected = [];
    allRows = [];
    lots = [];
    needToRefresh = false;
